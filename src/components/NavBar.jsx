...
import { setOpenList } from '../app/ListSlice.js';
      ...
      <header className={
        ...
        <nav className='flex items-center justify-between nike-container'>
            ...
            <li className='grid items-center'>
                    <button type='button' onClick={onListToggle} className='border-none outline-none active:scale-110 transition-all duration-300 relative'>
