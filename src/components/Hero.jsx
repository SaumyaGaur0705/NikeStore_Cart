...
const Hero = ({ heroapi: { title, subtitle, btntext,url, img, sociallinks, videos } }) => {
  ...
  <button className='button-theme bg-slate-200 shadow-slate-200 rounded-xl my-5'>
    <span className='flex items-center'> {/* Container for Explore Item and Magnifying Glass */}
      {btntext}
      <MagnifyingGlassIcon className='icon-style text-slate-900 transition-all duration-300 ml-2' /> {/* Adjust margin as needed */}
    </span>
  </button>
</a>
